...
public class PackageService : IPackageService
{
    ...
    public async Task<Package> CreatePackageAsync(CreatePackageDto dto, string? adminName)
    {
        ...
        await _logService.LogAsync("STWORZENIE_PAKIETU", $"Utworzono pakiet: {package.Name}", adminName ?? "System", null);
    ...
    public async Task UpdatePackageAsync(int id, UpdatePackageDto dto, string? adminName)
    {
        ...
        package.PriceValue = dto.PriceValue;
        ...
        await _context.SaveChangesAsync();
        await _logService.LogAsync("EDYCJA_PAKIETU", $"Zaktualizowano pakiet ID: {id}", adminName ?? "System", null);
    }
    ...
    public async Task DeletePackageAsync(int id, string? adminName)
    {
        ...
        await _context.SaveChangesAsync();
        await _logService.LogAsync("USUNIECIE_PAKIETU", $"Usunięto pakiet: {package.Name}", adminName ?? "System", null);
    }
}