...
public class AuthController : ControllerBase
{
    ...
    public async Task<IActionResult> Register([FromBody] RegisterDto registerDto)
    {
        ...
        {
            await SafeLogAsync("NIEUDANA_REJESTRACJA", $"Próba rejestracji na zajęty email: {registerDto.Email}", "System", "", "Warning");
        ...
        if (!result.Succeeded)
        {
            await SafeLogAsync("NIEUDANA_REJESTRACJA", $"Błąd rejestracji: {registerDto.Email}", "System", "", "Warning");
        ...
        if (!roleResult.Succeeded)
        {
            ...
            await SafeLogAsync("BLAD_SYSTEMU", $"Nie udało się nadać roli User dla {registerDto.Email}", "System", "", "Error");
    ...
    public async Task<IActionResult> ForgotPassword([FromBody] ForgotPasswordDto dto)
    {
        ...
        if (user == null)
        {
            ...
            await SafeLogAsync("RESET_HASLA", $"Żądanie resetu: {dto.Email}", "System", "", "Security");
    ...
    public async Task<IActionResult> ResetPassword([FromBody] ResetPasswordDto dto)
    {
        ...
        if (result.Succeeded)
        {
            ...
            await SafeLogAsync("RESET_HASLA", $"Hasło zmienione: {dto.Email}", "System", "", "Success");
