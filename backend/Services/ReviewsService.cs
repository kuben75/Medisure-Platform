...
public class ReviewsService : IReviewsService
{
    ...
    public async Task<bool> ApproveReviewAsync(int reviewId, string adminId, string adminName)
    {
        ...
        await _logService.LogAsync("ZAAKCEPTOWANIE_OPINII", $"Opinia ID {reviewId} zatwierdzona.", adminName, adminId);
    ...
    public async Task<bool> RejectReviewAsync(int reviewId, string adminId, string adminName)
    {
        ...
        await _logService.LogAsync("ODRZUCENIE_OPINII", $"Opinia ID {reviewId} usunięta.", adminName, adminId);
