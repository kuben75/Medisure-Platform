    ...
    return (
        <div className="border-b border-gray-100 last:border-none">
            <button
                ...
                onClick={onToggle}>
                <span className={`font-semibold transition-colors ${isOpen ? 'text-[#4E61F6]' : 'text-gray-700 group-hover:text-[#4E61F6]'}`}>{question}
                </span>
                <span className={`ml-4 transform transition-transform duration-300 text-gray-400 ${isOpen ? 'rotate-180 text-[#4E61F6]' : ''}`}>
