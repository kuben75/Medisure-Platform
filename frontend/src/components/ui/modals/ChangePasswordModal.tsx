        ...
        <Modal isOpen={isOpen} onClose={handleClose} className="max-w-md">
            {step === 'form' ? (
                    ...
                    <form onSubmit={handleInitialSubmit} className="space-y-4">
                        <div>
                            ...
                            <input type="password" value={form.currentPassword}
                                   onChange={e => form.setCurrentPassword(e.target.value)} required
                        ...
                        <div>
                            ...
                            <input type="password" value={form.newPassword}
                                   onChange={e => form.setNewPassword(e.target.value)} required
                                   className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#4E61F6] outline-none"/>
                        ...
                        <div>
                            ...
                            <input type="password" value={form.confirmPassword}
                                   onChange={e => form.setConfirmPassword(e.target.value)} required
                                   className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#4E61F6] outline-none"/>
                        </div>
                ...
                <div className="text-center animate-slide-in-right px-4">
                    <div
                        className="w-16 h-16 bg-amber-50 rounded-full flex items-center justify-center mx-auto mb-4 text-amber-500 animate-pulse">
                        <ShieldIcon/>
                    </div>
                    ...
                    <div className="flex gap-3">
                        ...
                        <Button onClick={submitChangePassword}
                                className="w-2/3 bg-amber-600 hover:bg-amber-700 border-amber-600 shadow-lg"
                                disabled={isLoading}>
