        ...
        <div className="mt-4 md:mt-8">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4 bg-white p-4 rounded-xl border border-gray-200 md:bg-transparent md:p-0 md:border-none">
                <div className="flex items-center gap-2">
                    ...
                    <button onClick={fetchLogs} className="p-2 text-gray-400 hover:text-[#4E61F6] hover:bg-blue-50 rounded-full transition-colors" title="Odśwież">
                ...
                <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                    <div className="relative flex-grow md:w-64">
                        <input type="text" placeholder="Szukaj..." className="w-full pl-9 pr-4 py-2 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-[#4E61F6] focus:border-transparent outline-none bg-gray-50 focus:bg-white transition-all"
                    ...
                    <select className="px-4 py-2 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-[#4E61F6] outline-none bg-white cursor-pointer w-full sm:w-auto"
            ...
            {hasMore && (
                <div className="mt-6 flex justify-center pb-4">
                    <button onClick={handleShowMore} className="flex items-center gap-2 px-6 py-2.5 bg-white text-gray-600 font-medium text-sm rounded-full shadow-sm border border-gray-300 hover:bg-gray-50 hover:text-[#4E61F6] hover:border-[#4E61F6] transition-all active:scale-95">
                        <span>Załaduj więcej</span>
                        <ChevronDownIcon className="w-4 h-4" />
                        <span className="text-xs text-gray-400 ml-1 font-normal">({displayedLogs.length} z {filteredLogs.length})</span>
                    </button>
                </div>
            )}
        </div>
