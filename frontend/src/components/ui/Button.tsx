import type {TButtonProps} from "../../types/ui.types.ts";

export default function Button({variant = "primary", className, children, ...rest}: TButtonProps) {
    const baseStyles = "py-4 px-6 text-[14px] md:text-[16px] rounded-lg " +
        "font-bold text-lg transition-all duration-300 shadow-lg hover:shadow-xl " +
