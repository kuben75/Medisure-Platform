...
export default function CookieConsent() {
    ...
    return (
        <div
            className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] p-6 z-[100] animate-slide-up">
            <div className="container mx-auto max-w-6xl flex flex-col lg:flex-row items-center justify-between gap-6">
                <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 leading-relaxed">
                        ...
                        personalizacji treści oraz prowadzenia statystyk. Możesz zaakceptować wszystkie cookies albo
                        wybrać tylko te niezbędne.
                        Szczegóły znajdziesz w naszej <Link to="/polityka-cookies"
                                                            className="text-[#4E61F6] font-medium hover:underline">Polityce
                        Cookies</Link>.
                    </p>
                </div>
