...
export default function ReviewManagement() {
    ...
    return (
        <div className="mt-4 md:mt-8 bg-white md:bg-slate-50 p-4 md:p-6 rounded-xl md:border border-gray-200">
            ...
            {reviews.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-16 bg-white md:bg-transparent rounded-xl border border-dashed border-gray-300 md:border-gray-300">
                ...
                <div className="grid grid-cols-1 gap-4">
                    {reviews.map((review) => (
                        <div key={review.id} className="bg-white p-5 rounded-xl shadow-sm border border-gray-200 flex flex-col md:flex-row gap-5 md:gap-8 transition-all hover:shadow-md">

                            <div className="md:w-[240px] flex-shrink-0 flex flex-col border-b md:border-b-0 md:border-r border-gray-100 pb-4 md:pb-0 md:pr-6">
                                ...
                                <div className="mt-auto">
                                    <span className="inline-block bg-blue-50 text-blue-700 px-2 py-1 rounded text-[10px] font-bold uppercase tracking-wide border border-blue-100">
                                        {review.packageName}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-row md:flex-col gap-2 justify-end md:justify-center md:w-32 border-t md:border-t-0 md:border-l border-gray-100 pt-4 md:pt-0 md:pl-6">
                                <Button
