...
export default function BroadcastPanel() {
    ...
    return (
        <div className="mt-8 bg-white p-8 rounded-2xl shadow-lg border border-gray-200 flex flex-col lg:flex-row gap-10">
                ...
                <form onSubmit={handleSend} className="space-y-5">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="md:col-span-2">
                            ...
                            <input
                                ...
                                className="w-full border border-gray-300 p-3 rounded-xl focus:ring-2 focus:ring-[#4E61F6] outline-none transition-all"
                                required
                            />
                        </div>
                        <div>
                            ...
                            <select
                                ...
                                className="w-full border border-gray-300 p-3 rounded-xl focus:ring-2 focus:ring-[#4E61F6] outline-none bg-white cursor-pointer"
                            >
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full border border-gray-300 p-3 rounded-xl h-32 focus:ring-2 focus:ring-[#4E61F6] outline-none resize-none transition-all"
                            required
                        />
                        <div className="flex justify-between mt-1 text-xs text-gray-400">
                            <span>Markdown nieobsługiwany</span>
                            <span>{message.length} znaków</span>
                        </div>
                    </div>

                    <div className="pt-2">
                        <Button type="submit" disabled={loading} className="w-full py-3 shadow-lg font-bold">
            ...
            <div className="lg:w-1/3 bg-gray-50 rounded-2xl p-6 border border-gray-200 flex flex-col justify-center">
                <p className="text-xs font-bold text-gray-400 uppercase mb-4 text-center tracking-widest">Podgląd na żywo</p>

                <div className={`bg-white p-5 rounded-xl border-l-4 shadow-sm ${previewStyle.border} relative overflow-hidden transition-all duration-300`}>
                    ...
                    <div className="absolute top-4 right-2 w-2 h-2 bg-red-500 rounded-full border border-white shadow-sm"></div>
                </div>
