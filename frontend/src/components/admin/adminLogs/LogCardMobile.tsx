        ...
        <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm mb-3">
            <div className="flex justify-between items-start mb-3" onClick={() => setIsExpanded(!isExpanded)}>
                <div className="flex flex-col gap-1">
                    <span
                        className="text-[10px] text-gray-400 font-mono">{new Date(log.timestamp).toLocaleString('pl-PL')}</span>
            ...
            {isExpanded &&
                <div className="mt-3 pt-3 border-t border-gray-100 animate-fade-in"><LogDetails log={log}/></div>}
        </div>
    );
};