...
export default function AdminPanel() {
    ...
    return (
        <div className="min-h-screen bg-slate-100 font-sans">
            ...
            <div
                className="md:hidden bg-white shadow-sm border-b border-gray-200 p-4 sticky top-0 z-30 flex justify-between items-center">
            ...
            {isSidebarOpen && (
                <div className="fixed inset-0 z-50 md:hidden">
                    ...
                    <div
                        className="absolute left-0 top-0 bottom-0 w-[280px] bg-white shadow-2xl flex flex-col animate-slide-in-left">
                        ...
                        <div className="p-4 border-t border-gray-100 space-y-2 bg-gray-50">
                            ...
                            <Button variant="primary"
                                    className="w-full justify-center !py-2.5 text-sm flex items-center gap-2"
            ...
            <div className="max-w-7xl mx-auto md:p-8 p-0">
                ...
                <div
                    className="bg-white md:rounded-2xl md:shadow-lg md:border border-gray-200 min-h-[calc(100vh-4rem)] md:min-h-0 overflow-hidden">

                    <div
                        className="hidden md:flex flex-col md:flex-row justify-between md:items-center p-6 md:p-8 border-b border-gray-100">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-800">Panel Administratora</h1>
                            <p className="text-gray-500 mt-1">Zalogowany jako: <span
                                className="font-medium text-gray-900">{user?.firstName || user?.email}</span></p>
                        </div>
                        <div className="flex gap-3">
                            <Button variant="secondary"
                                    className="!py-2.5 !px-5 border-gray-300 text-gray-600 hover:bg-gray-50"
                                    onClick={() => navigate('/')}>
                                Podgląd strony
                            </Button>
                            <Button variant="primary"
                                    className="!py-2.5 !px-5 flex items-center gap-2 shadow-md shadow-blue-500/20"
                                    onClick={handleLogout}>
