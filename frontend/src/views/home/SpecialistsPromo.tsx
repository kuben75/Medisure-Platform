        ...
        <section className="py-20 px-4 bg-white">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
                ...
                <div className="md:w-1/2 relative">
                    ...
                    <div className="relative bg-white p-8 rounded-3xl shadow-xl border border-gray-100 max-w-sm mx-auto">
                        ...
                        <div className="space-y-4">
                            {PROMO_SPECIALISTS.map((item, i) => (
                                ...
                                >
                                    ...
                                    <span className="text-xs bg-white px-2 py-1 rounded border border-gray-200 text-gray-500 group-hover:border-blue-200 group-hover:text-blue-600">Dostępny</span>
                                </div>
                            ))}
                        ...
                        <div className="absolute -bottom-6 -right-6 bg-[#4E61F6] text-white p-4 rounded-2xl shadow-lg flex items-center gap-3 animate-bounce-slow pointer-events-none">
                            <StethoscopeIcon />
                            <div>
