        ...
        <section className="py-20 px-4 bg-gradient-to-b from-slate-50 to-white border-b border-gray-200" id="results">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center mb-16">
                    <span className="text-indigo-600 font-bold tracking-widest uppercase text-xs bg-indigo-50 px-4 py-1.5 rounded-full border border-indigo-100 shadow-sm">
                        Wynik Analizy
                    </span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                        ...
                        <div className="relative z-10 flex flex-col h-full">
                            <div className="mb-8">
                                ...
                                {budgetExceeded && !isContactRequired && (
                                    <div className="mb-4 bg-orange-50 border border-orange-100 rounded-xl p-4 text-xs text-orange-800 leading-relaxed shadow-sm">
                                        <div className="flex gap-2 items-start">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-orange-500 shrink-0 mt-0.5"><path fillRule="evenodd" d="M9.401 3.003c1.155-2 4.043-2 5.197 0l7.355 12.748c1.154 2-.29 4.5-2.599 4.5H4.645c-2.309 0-3.752-2.5-2.598-4.5L9.4 3.003zM12 8.25a.75.75 0 01.75.75v3.75a.75.75 0 01-1.5 0V9a.75.75 0 01.75-.75zm0 8.25a.75.75 0 100-1.5.75.75 0 000 1.5z" clipRule="evenodd" /></svg>
                                            <span>
                                ...
                                {isFamilyCustom ? (
                                    <div>
                                        <div className="text-3xl font-extrabold text-[#4E61F6] tracking-tight leading-tight mb-2">
                                            Oferta Dedykowana
                                        </div>
                                        <p className="text-sm text-gray-600 font-medium">
                                            Dla dużych rodzin przygotowujemy pakiety "szyte na miarę". Skontaktuj się z nami, aby omówić szczegóły.
                                        </p>
                                    </div>
                                ) : isCompany ? (
                                    estimatedPrice > 0 ? (
                                        <>
                                            <div className="flex items-baseline gap-1.5 flex-wrap">
                                                ...
                                                <span className="text-6xl font-extrabold tracking-tighter text-[#4E61F6]">
                                                    {estimatedPrice}
                                                </span>
                                                <span className="text-2xl font-bold text-gray-400">zł</span>
                                            </div>
                                            <p className="text-xs text-gray-400 mt-2">Cena netto za osobę przy min. 30 pracownikach.</p>
                                        </>
                                    ) : (
                                        <div>
                                            <div className="text-3xl font-extrabold text-[#4E61F6] tracking-tight leading-tight mb-2">
                                            ...
                                            <p className="text-sm text-gray-500">Skontaktuj się w celu ustalenia zakresu usług dla firmy.</p>
                                        </div>
                                    )
                                ) : (
                                    <>
                            ...
                            {isCompany && (
                                <div className="mb-6 p-4 bg-amber-50 rounded-xl border border-amber-100 text-xs text-amber-800 leading-relaxed">
                            ...
                            {isContactRequired ? (
                                <Link to="/kontakt" className="w-full">
                                    <Button variant="secondary" className="w-full border-gray-300 hover:border-[#4E61F6] hover:text-[#4E61F6] py-3">
                    ...
                    <div className="lg:col-span-7 relative group h-full">
                        <div className="absolute inset-0 bg-[#4E61F6] rounded-[24px] transform translate-y-2 translate-x-2 opacity-10 group-hover:translate-y-3 group-hover:translate-x-3 transition-transform duration-300 -z-10"></div>

                        <div className="bg-gradient-to-br from-[#4E61F6] to-indigo-900 rounded-[24px] p-1 shadow-2xl h-full flex flex-col">
                            <div className="bg-white/10 backdrop-blur-md h-full w-full rounded-[20px] p-8 md:p-10 flex flex-col relative overflow-hidden border border-white/10">
                                ...
                                <div className="flex flex-col sm:flex-row justify-between items-start mb-8 relative z-10 gap-4">
                                    ...
                                    {recommendedPlan && !isContactRequired && user && (
                                        <div className="bg-white/20 p-2 rounded-full hover:bg-white/30 transition-colors cursor-pointer backdrop-blur-sm border border-white/10 shadow-lg">
                                ...
                                <div className="flex-grow relative z-10">
                                    {recommendedPlan ? (
                                        ...
                                        <div className="flex flex-col justify-center h-40 text-blue-100">
                                            ...
                                            <p className="opacity-80">Nasi doradcy pomogą dobrać najlepsze rozwiązanie.</p>
                                        </div>
                                    )}
                                </div>
