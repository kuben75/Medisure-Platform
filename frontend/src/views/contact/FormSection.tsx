...
export default function FormSection() {
    const {
        ...
        isLoading, handleSubmit, getInputClass
    } = useFormSection();
                        ...
                        <form className="space-y-5" onSubmit={handleSubmit}>
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-1">
                                    ...
                                    <span
                                        className={`text-xs ${formData.message.length >= 1000 ? 'text-red-500 font-bold' : 'text-gray-400'}`}>
                            ...
                            <div className="pt-2">
                                <label htmlFor="agreement" className="flex items-start cursor-pointer group">
                                    ...
                                    <div
                                        className={`ml-3 text-sm transition-colors ${errors.agreement ? 'text-red-600' : 'text-gray-600 group-hover:text-gray-800'}`}>
                                        Oświadczam, że zapoznałem/am się z <Link to="/polityka-prywatnosci"
                                                                                 className={`font-medium hover:underline ${errors.agreement ? 'text-red-700' : 'text-[#4E61F6]'}`}>Polityką
                                        Prywatności</Link> i akceptuję zasady przetwarzania danych.
                                    </div>
                                </label>
                                {errors.agreement && (
